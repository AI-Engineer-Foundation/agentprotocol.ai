...
To check if your agent is compliant with the Agent Protocol, you can use the [Agent Protocol Testing Suite](https://github.com/AI-Engineers-Foundation/agent-protocol/tree/main/testing_suite). The testing suite uses `npm` and `newman` to run a Postman routine against the agent. {{ className: 'lead' }}
